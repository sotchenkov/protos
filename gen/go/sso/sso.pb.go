...
func (x *IsAdminRespons) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*IsAdminRespons) ProtoMessage() {}

func (x *IsAdminRespons) ProtoReflect() protoreflect.Message {
	mi := &file_sso_sso_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use IsAdminRespons.ProtoReflect.Descriptor instead.
func (*IsAdminRespons) Descriptor() ([]byte, []int) {
	return file_sso_sso_proto_rawDescGZIP(), []int{5}
}

func (x *IsAdminRespons) GetIsAdmin() bool {
	if x != nil {
		return x.IsAdmin
	}
	return false
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x49, 0x64, 0x22, 0x2b, 0x0a, 0x0e, 0x49, 0x73, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x12, 0x19, 0x0a, 0x08, 0x69, 0x73, 0x5f, 0x61, 0x64, 0x6d, 0x69, 0x6e,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x07, 0x69, 0x73, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x32,
	0xaa, 0x01, 0x0a, 0x04, 0x41, 0x75, 0x74, 0x68, 0x12, 0x39, 0x0a, 0x08, 0x52, 0x65, 0x67, 0x69,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x35, 0x0a, 0x07, 0x49, 0x73, 0x41, 0x64, 0x6d, 0x69, 0x6e,
	0x12, 0x14, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x49, 0x73, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x14, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x49, 0x73,
	0x41, 0x64, 0x6d, 0x69, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x42, 0x19, 0x5a, 0x17,
	0x73, 0x6f, 0x74, 0x63, 0x68, 0x65, 0x6e, 0x6b, 0x6f, 0x76, 0x2e, 0x73, 0x73, 0x6f, 0x2e, 0x76,
...
var file_sso_sso_proto_goTypes = []interface{}{
	...
	(*IsAdminRespons)(nil),   // 5: auth.IsAdminRespons
}
var file_sso_sso_proto_depIdxs = []int32{
	...
	5, // 5: auth.Auth.IsAdmin:output_type -> auth.IsAdminRespons
