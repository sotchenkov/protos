...
type AuthClient interface {
	...
	IsAdmin(ctx context.Context, in *IsAdminRequest, opts ...grpc.CallOption) (*IsAdminRespons, error)
}
...
func (c *authClient) IsAdmin(ctx context.Context, in *IsAdminRequest, opts ...grpc.CallOption) (*IsAdminRespons, error) {
	out := new(IsAdminRespons)
...
type AuthServer interface {
	...
	IsAdmin(context.Context, *IsAdminRequest) (*IsAdminRespons, error)
...
func (UnimplementedAuthServer) IsAdmin(context.Context, *IsAdminRequest) (*IsAdminRespons, error) {
